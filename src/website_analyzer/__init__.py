"""
Analizator Stron Internetowych - Pakiet główny

Ten pakiet zawiera aplikację GUI do pobierania i analizowania stron internetowych.
...
- Parsowanie HTML i analiza tekstu
"""
